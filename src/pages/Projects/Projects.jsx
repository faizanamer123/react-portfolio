...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A task management application with features like task categorization, priorities, and due dates.',
      image: customImg,
    ...
    },
    {
      ...
      description: 'A weather dashboard showing current conditions and forecasts for multiple locations.',
      image: codeImg,
    ...
    },
    {
      ...
      description: 'A dashboard to manage and analyze multiple social media accounts from one interface.',
      image: developerImg,
